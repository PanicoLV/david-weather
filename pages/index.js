...
{
  /*setup useStates for setting city,weather and if loading*/
}
export default function Home() {
  ...
  {
    /*setup fetchWeather function to get data from api*/
  }
  const fetchWeather = (e) => {
    ...
    setLoading(true);
    {
      /**creates promise if axios gets data to create a response by setting the weather to the data passed by the response*/
    }
